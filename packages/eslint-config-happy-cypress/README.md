...
<h3 align="center">eslint-config-happy-cypress</h3>

<p align="center">
    <a href="https://www.npmjs.org/package/eslint-config-happy-cypress"><img src="https://img.shields.io/npm/v/eslint-config-happy-cypress.svg" alt="npm version" /></a>
...
```
npx install-peerdeps --dev eslint-config-happy-cypress
```
