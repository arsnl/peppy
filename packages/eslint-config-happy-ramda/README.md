...
<h3 align="center">eslint-config-happy-ramda</h3>

<p align="center">
    <a href="https://www.npmjs.org/package/eslint-config-happy-ramda"><img src="https://img.shields.io/npm/v/eslint-config-happy-ramda.svg" alt="npm version" /></a>
...
```
npx install-peerdeps --dev eslint-config-happy-ramda
```
