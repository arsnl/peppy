...
<h3 align="center">eslint-config-peppy-node</h3>

<p align="center">
    <a href="https://www.npmjs.org/package/eslint-config-peppy-node"><img src="https://img.shields.io/npm/v/eslint-config-peppy-node.svg" alt="npm version" /></a>
...
```
npx install-peerdeps --dev eslint-config-peppy-node
```
