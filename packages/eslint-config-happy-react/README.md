...
<h3 align="center">eslint-config-happy-react</h3>

<p align="center">
    <a href="https://www.npmjs.org/package/eslint-config-happy-react"><img src="https://img.shields.io/npm/v/eslint-config-happy-react.svg" alt="npm version" /></a>
...
```
npx install-peerdeps --dev eslint-config-happy-react
```
