...
} = require("eslint-config-happy/rules/best-practices");
const { rules: baseErrorsRules } = require("eslint-config-happy/rules/errors");
const { rules: baseES6Rules } = require("eslint-config-happy/rules/es6");
const {
  rules: baseImportsRules,
} = require("eslint-config-happy/rules/imports");
const { rules: baseStyleRules } = require("eslint-config-happy/rules/style");
const {
  rules: baseVariablesRules,
} = require("eslint-config-happy/rules/variables");
