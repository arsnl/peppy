...
<p align="center">
    <a href="https://www.npmjs.org/package/eslint-config-peppy-jest"><img src="https://img.shields.io/npm/v/eslint-config-peppy-jest.svg" alt="npm version" /></a>
...
<h2 align="center">eslint-config-peppy-jest</h2>
...
```
npx install-peerdeps --dev eslint-config-peppy-jest
```
