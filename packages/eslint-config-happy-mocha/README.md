...
<h3 align="center">eslint-config-happy-mocha</h3>

<p align="center">
    <a href="https://www.npmjs.org/package/eslint-config-happy-mocha"><img src="https://img.shields.io/npm/v/eslint-config-happy-mocha.svg" alt="npm version" /></a>
...
```
npx install-peerdeps --dev eslint-config-happy-mocha
```
