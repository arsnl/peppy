...
} = require("eslint-config-peppy/rules/best-practices");
const { rules: baseErrorsRules } = require("eslint-config-peppy/rules/errors");
const { rules: baseES6Rules } = require("eslint-config-peppy/rules/es6");
const {
  rules: baseImportsRules,
} = require("eslint-config-peppy/rules/imports");
const { rules: baseStyleRules } = require("eslint-config-peppy/rules/style");
const {
  rules: baseVariablesRules,
} = require("eslint-config-peppy/rules/variables");
